...
@section('title', 'Word Management' . ' | ' . 'Edit Translation')

@section('content') 
{{ html()->modelForm($translate, 'PATCH', route('frontend.record.word.translate.update', [$word, $translate]))->class('form-horizontal')->open() }}
    <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="col-sm-5">
        ...
        <div class="card-footer">
            <div class="row">
                <div class="col">
                    {{ form_cancel(route('frontend.record.word.show', $word), __('buttons.general.cancel')) }}
                </div><!--col-->
