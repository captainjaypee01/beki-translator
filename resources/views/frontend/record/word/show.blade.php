            ...
            <div class="col">
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="overview" role="tabpanel" aria-expanded="true">
                        @include('frontend.record.word.show.tabs.overview')
                    </div><!--tab-->
                    <div class="tab-pane " id="translations" role="tabpanel" aria-expanded="true">
                        @include('frontend.record.word.show.tabs.translations')
                    </div><!--tab-->
                </div><!--tab-content-->
            </div><!--col-->
        </div><!--row-->
    ...
    <div class="card-footer">
        <div class="row">
            <div class="col col-md-3">
                <a href="{{route('frontend.record.word.index')}}" class="btn btn-info btn-sm">Go Back</a>
            </div>
